...
def parse_args():
    ...
    Options_trees.add_argument('-m', '--manual_mode', metavar="\"x/y,z/...\"", type=str,
                        help="User defined convergent transition/branches. Transition node must be the first number and independent events must be separated by a \"/\". ex: \"1,2,3/67/55,56\" (default: None)",
                        default="")
...
def mk_simu((i, tree_filename, OutDirNamePrefixTree,
            Nbsimul,
            manual_mode_nodes,
            flg,
            bl_new,
            ...
            minTrans,
            maxConvRate,
            repseq0, repest0, reptree0, repplottreeali0, replikelihoodsummary0, repbppconfig,
            ev_noise,
            root_noise,
            CATcouples,
            Nb_sampled_couple,
    ...
    for (c1,c2) in SampledCATcouples:
        ...
        # recovers sequence reconstructions for "identical" method.
        if args.ident:
